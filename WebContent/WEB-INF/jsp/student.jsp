	...
	<div class="bg">
		<div class="box">
			<div class="box-content">
				<div class="title">家长留言板</div>
				<form class="form" action="addPersonText" method="post">
					<input placeholder="请填写孩子班级" class="name1" name="personClass">
					<input placeholder="请填写孩子姓名" class="name" name="personName">
					<textarea placeholder="简要描写孩子本周的学习情况，进步成长。" class="liuyan"
						name="personText" cols="51" rows="10"></textarea>
					<input type="text" value="" name="fingerPrint" id="fingerPrint"
						name="fingerPrint" style="display: none" /> <input type="text"
						value="" name="fingerPrintHash" id="fingerPrintHash"
						style="display: none" />
					<button class="login-btn">提交</button>
					<p class="info">温馨提示：请用电脑端登陆</p>
