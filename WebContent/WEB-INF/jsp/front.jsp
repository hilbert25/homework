	...
	<div>
		...
		<div class="content">
			<form action="updateHomeWork" method="post" enctype="multipart/form-data">
				<div class="module">
					修改第：<input type="text" placeholder="请输入X" name="courseIndex">
					作业内容：<input type="text" placeholder="请输入作业内容" name="courseHomeWork">
				</div>
				<div class="module">
		...
		<div class="content">
			<form action="searchAllHomeWorkByIndex" method="post"
				enctype="multipart/form-data">
				<div class="module">
					查询第x次作业：<input type="text" placeholder="请输入X" name="homeWorkIndex">
				</div>
				<div class="module">
					<button type="submit">提交</button>
				</div>
